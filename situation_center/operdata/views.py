...
def uslugi_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'uslugi_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
...
def finpr_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'finpr_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
...
def price_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'price_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
...
def prodprice_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'prodprice_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
...
def revenue_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'revenue_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
...
def salary_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'salary_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
...
def joblessness_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'joblessness_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
...
def jobmarket_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'jobmarket_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
...
def smcompany_detail(request, slug):
    ...
    # Создаем уникальный ключ для кэша
    cache_key = f'smcompany_detail_{slug}_{request.GET.get("region", "all")}'
    cached_data = cache.get(cache_key)
