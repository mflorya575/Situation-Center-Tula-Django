...
def capitalassets_view(request, slug):
    ...
    if request.method == "POST":
        ...
        return render(request, "ai/capitalassets_result.html", context)

    data = process_csv_data(capitalassets.csv_file.path)
    columns = data.columns

    return render(request, "ai/capitalassets_detail.html", {
        "capitalassets": capitalassets,
        "columns": columns,
        'title': 'СЦ РЭУ филиал им. Г.В. Плеханова',
    })
...
def organization_view(request, slug):
    ...
    if request.method == "POST":
        ...
        return render(request, "ai/organization_result.html", context)

    data = process_csv_data(organization.csv_file.path)
    columns = data.columns

    return render(request, "ai/organization_detail.html", {
        "organization": organization,
        "columns": columns,
        'title': 'СЦ РЭУ филиал им. Г.В. Плеханова',
    })
...
def shlrr_view(request, slug):
    ...
    if request.method == "POST":
        ...
        return render(request, "ai/shlrr_result.html", context)

    data = process_csv_data(shlrr.csv_file.path)
    columns = data.columns

    return render(request, "ai/shlrr_detail.html", {
        "shlrr": shlrr,
        "columns": columns,
        'title': 'СЦ РЭУ филиал им. Г.В. Плеханова',
    })
...
def infotechnology_view(request, slug):
    ...
    if request.method == "POST":
        ...
        return render(request, "ai/infotechnology_result.html", context)

    data = process_csv_data(infotechnology.csv_file.path)
    columns = data.columns

    return render(request, "ai/infotechnology_detail.html", {
        "infotechnology": infotechnology,
        "columns": columns,
        'title': 'СЦ РЭУ филиал им. Г.В. Плеханова',
    })
...
def finance_view(request, slug):
    ...
    if request.method == "POST":
        ...
        return render(request, "ai/finance_result.html", context)

    data = process_csv_data(finance.csv_file.path)
    columns = data.columns

    return render(request, "ai/finance_detail.html", {
        "finance": finance,
        "columns": columns,
        'title': 'СЦ РЭУ филиал им. Г.В. Плеханова',
    })
...
def foreigntrading_view(request, slug):
    ...
    if request.method == "POST":
        ...
        return render(request, "ai/foreigntrading_result.html", context)

    data = process_csv_data(foreigntrading.csv_file.path)
    columns = data.columns

    return render(request, "ai/foreigntrading_detail.html", {
        "foreigntrading": foreigntrading,
        "columns": columns,
        'title': 'СЦ РЭУ филиал им. Г.В. Плеханова',
    })
...
def vrp_view(request, slug):
    ...
    if request.method == "POST":
        ...
        return render(request, "ai/vrp_result.html", context)

    data = process_csv_data(vrp.csv_file.path)
    columns = data.columns

    return render(request, "ai/vrp_detail.html", {
        "vrp": vrp,
        "columns": columns,
        'title': 'СЦ РЭУ филиал им. Г.В. Плеханова',
    })
