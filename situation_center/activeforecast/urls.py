...
urlpatterns = [
    ...
    path('prodprice/<slug:slug>/', views.prodprice_detail, name='prodprice_detail'),
    # Доходы
    path('revenue/', views.revenue, name='revenue'),
    path('revenue/<slug:slug>/', views.revenue_detail, name='revenue_detail'),
    # Зарплата
    path('salary/', views.salary, name='salary'),
    path('salary/<slug:slug>/', views.salary_detail, name='salary_detail'),
    # Безработица
    path('joblessness/', views.joblessness, name='joblessness'),
    path('joblessness/<slug:slug>/', views.joblessness_detail, name='joblessness_detail'),
    # Рынок труда
    ...
    path('population/<slug:slug>/', views.population_detail, name='population_detail'),
    ...
    path('capitalassets/<slug:slug>/', views.capitalassets_detail, name='capitalassets_detail'),
    ...
    path('foreigntrading/<slug:slug>/', views.foreigntrading_detail, name='foreigntrading_detail'),
