...
def building_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{building.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/building_detail.html', context)
...
def transport_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{transport.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/transport_detail.html', context)
...
def trading_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{trading.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/trading_detail.html', context)
...
def uslugi_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{uslugi.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/uslugi_detail.html', context)
...
def investing_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{investing.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/investing_detail.html', context)
...
def finpr_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{finpr.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/finpr_detail.html', context)
...
def price_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{price.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/price_detail.html', context)
...
def prodprice_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{prodprice.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/prodprice_detail.html', context)
...
def revenue_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{revenue.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/revenue_detail.html', context)
...
def salary_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{salary.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/salary_detail.html', context)
...
def joblessness_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{joblessness.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/joblessness_detail.html', context)
...
def jobmarket_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{jobmarket.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/jobmarket_detail.html', context)
...
def smcompany_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{smcompany.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    # Создание формы для выбора региона
    region_form = SmallMediumCompanyForm(request.GET or None, smcompany_slug=slug)
    ...
    return render(request, 'activeforecast/smcompany_detail.html', context)
...
def population_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{population.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/population_detail.html', context)
...
def levelhealth_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{levelhealth.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/levelhealth_detail.html', context)
...
def securenature_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{securenature.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/securenature_detail.html', context)
...
def capitalassets_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{capitalassets.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/capitalassets_detail.html', context)
...
def shlrr_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{shlrr.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/shlrr_detail.html', context)
...
def infotechnology_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{infotechnology.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/infotechnology_detail.html', context)
...
def finance_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{finance.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/finance_detail.html', context)
...
def foreigntrading_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{foreigntrading.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/foreigntrading_detail.html', context)
...
def vrp_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{vrp.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    return render(request, 'activeforecast/vrp_detail.html', context)
...
def industrialprod_detail(request, slug):
    ...
    if df_melted.empty:
        ...
        fig_linear.update_layout(
            title=f'{industrialprod.title} - Комбинированный график с прогнозом (Линейная шкала)',
            xaxis_title='Годы',
            yaxis_title='Количество'
        )
        combined_chart_linear = fig_linear.to_html(full_html=False)
    ...
    # Создание формы для выбора региона
    region_form = IndustrialProdForm(request.GET or None, industrialprod_slug=slug)
    ...
    return render(request, 'activeforecast/industrialprod_detail.html', context)
